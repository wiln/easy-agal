package com.barliesque.agal {
	...
	*/
	public class EasierAGAL extends EasyBase {
		 ...
		 */
		public function EasierAGAL(debug:Boolean = true, assemblyDebug:Boolean = false, verboseAssembly:Boolean = false) {
		...
		*/
		 ...
		 */
		static protected function sampleTexture(dest:IField, source1:IField, source2:Sampler, flags:Array = null):void {
