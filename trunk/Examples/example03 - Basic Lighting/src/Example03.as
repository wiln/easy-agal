package {
	 ...
	 * @author David Barlia
	 */
	public class Example03 extends MovieClip {
		...
		private function contextReady(event:Event):void {
			...
			var vertexData:Vector.<Number> = Vector.<Number>([
				...
				0.5, -0.5,	0,		//<- 4th vertex x,y,z
				-0.5, -0.5,	0.5,	//<- 5th vertex x,y,z
				-0.5, 0.5,	0.5,	//<- 6th vertex x,y,z
				0.5,  0.5,	0.5,	//<- 7th vertex x,y,z
				0.5, -0.5,	0.5,	//<- 8th vertex x,y,z
				]);
			
			// Connect the vertices into triangles (in counter-clockwise order)
			var indexData:Vector.<uint> = Vector.<uint>([
				0, 1, 2,	// <-- 1st Triangle Front
				0, 2, 3,	// <-- 2nd Triangle Front
				4, 5, 1,	// <-- 1st Triangle Left
				4, 1, 0,	// <-- 2nd Triangle Left
				3, 6, 7,	// <-- 1st Triangle Right
				3, 2, 6,	// <-- 2nd Triangle Right
				4, 6, 5,	// <-- 1st Triangle Back
				4, 7, 6,	// <-- 2nd Triangle Back
				4, 0, 2,	// <-- 1st Triangle Top
				4, 2, 7,	// <-- 2nd Triangle Top
				1, 5, 6,	// <-- 1st Triangle Bottom
				1, 6, 2,	// <-- 2nd Triangle Bottom
			]);
		...
		public function makeViewMatrix():Matrix3D {
			...
			var fov:Number = 90 * DEGS_TO_RADIANS;
